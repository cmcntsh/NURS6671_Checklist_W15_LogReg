...
| :---: | :---: | :---: | :---: | :---: | :---: |
| <br><br><br> |  | **Nominal**  | **Ordinal** | **Interval** | **Ratio** |
| **Dependent<br>(or Outcome)<br>Variable (DV)**<br><br> | **Nominal** | <br>$\textcolor{red}{Add \ this \ test:}$ (prediction) Logistic Regression | <br>$\textcolor{red}{Add \ this \ test:}$ (prediction) Logistic Regression | <br>$\textcolor{red}{Add \ this \ test:}$ (prediction) Logistic Regression | <br>$\textcolor{red}{Add \ this \ test:}$ (prediction) Logistic Regression |
| <br><br><br> | **Ordinal** | <br>$\textcolor{red}{Add \ this \ test:}$ (prediction) Logistic Regression | <br>$\textcolor{red}{Add \ this \ test:}$ (prediction) Logistic Regression | <br>$\textcolor{red}{Add \ this \ test:}$ (prediction) Logistic Regression | <br>$\textcolor{red}{Add \ this \ test:}$ (prediction) Logistic Regression |
| <br><br><br> | **Interval** | (2 categorical IV) two-way ANOVA<br>(skewed data) Kruskal-Wallis test<br>(prediction) Multiple Regression | (2 categorical IV) two-way ANOVA<br>(skewed data) Kruskal-Wallis test<br>(prediction) Multiple Regression | <br>(prediction) Multiple Regression | <br>(prediction) Multiple Regression |
| <br><br><br> | **Ratio** | (2 categorical IV) two-way ANOVA<br>(skewed data) Kruskal-Wallis test<br>(prediction) Multiple Regression | (2 categorical IV) two-way ANOVA<br>(skewed data) Kruskal-Wallis test<br>(prediction) Multiple Regression | <br>(prediction) Multiple Regression | <br>(prediction) Multiple Regression |
...
| <br><br><br><br> |
| **--------------------Section #3: Individual Test Information (Logistic Regression)--------------------** |
|  |
...
| $\textcolor{red}{Update \ this \ section:}$ <br>Chi square(df) = [value], p = [p-value]<br><br> |
...
| $\textcolor{red}{Update \ this \ section:}$ <br>Regression diagnostics:<br><br>Model checking:<br>Collinearity statistics (VIF) should be under 5 and are problematic if 10 or higher<br><br>Identify influential cases using Cook's distance: <br>Values for Cook's distance greater than 1 are potentially problematic, and it should be explored why those cases are different and how they impact the analysis.<br><br>Classification Table (What percent are correctly identified for each category?)<br>Accuracy<br>Sensitivity<br>Specificity<br> |
| What is the effect size? What is the interpretation of the effect size? |
| $\textcolor{red}{Update \ this \ section:}$ <br>Model overall:<br>Cox & Snell R squared = <br>Nagelkerke R squared<br>Each parameter:<br>odds ratio<br> |
...
| $\textcolor{red}{Update \ this \ section:}$ A report about logistic regression should include these elements: Describe the model and the purpose.<br>Model summary (Cox & Snell and Nagelkerke R squared, Chi-square test and p-value); Regression coefficients (Model coefficients B, standard error, Wald Z statistic and p-value, odds ratios, confidence intervals); Interpretation of key findings; Assumption checks.<br>A binary logistic regression was conducted to examine the effect of age, gender, and smoking status on the likelihood of developing lung cancer. The logistic regression model was statistically significant, χ²(3) = 27.53, p < .001, indicating that the predictors reliably distinguished between patients with and without lung cancer. The model explained 42.6% (Nagelkerke R²) of the variance and correctly classified 78.2% of cases. Age was a significant predictor of lung cancer (B = 0.08, SE = 0.02, Wald = 14.53, p < .001), with an odds ratio of 1.08 (95% CI: 1.04–1.13), indicating that each additional year of age increased the odds of lung cancer by 8%. Smoking status was also significant (B = 1.64, p < .001), with smokers having 5.16 times greater odds of developing lung cancer (95% CI: 2.47–10.78) compared to non-smokers.<br> |
| **--------------------References--------------------** |
